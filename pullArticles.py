...
def getarticles(ls,m):
    ...
    for l in range(numlinks):
        ...
        mypath= '/Users/isarasuntichotinun/Desktop/ANNIE/CSC 591/Data/riot{0}'.format(m)
...
def searchengine(searchphrase,m):
    ...
    for link in soup.find_all('a'):
         links[i,0]=link.get('href')
         i=i+1
    #remove duplicate links
    #links=links.tolist() #not needed
    uniquelinks=[]
    for item in links:
